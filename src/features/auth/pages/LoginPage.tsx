  ...
  return (
    <div className="min-h-screen bg-slate-50 grid place-items-center p-6">
      <div className="w-full max-w-md rounded-2xl border bg-white shadow-sm p-6">
        <div className="mb-6">
          <div className="text-xl font-bold text-slate-800">PROJETO PETS/TUTORES</div>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={a.loading}
            className="w-full px-4 py-2 rounded-xl bg-black text-white hover:bg-gray-800 disabled:opacity-50"
          >
            {a.loading ? "Entrando..." : "Entrar"}
          </button>

          <div className="text-xs text-slate-500">
            Dica: Para esse ambiente, utilize o usuario/senha: <b>admin/admin</b>.
          </div>
        </form>
      </div>
    </div>
