...
export function Sidebar() {
  return (
    <aside className="hidden md:flex md:w-64 bg-black text-white flex-col">
      <div className="p-5 border-b border-white/10">
        <div className="font-bold">Pets/Tutores</div>
        <div className="text-xs text-white/70">Cuiabá-MT</div>
      </div>
